...
class IndicatorLayoutIntro : LinearLayout {
    ...
    private fun updateIndicators() {
        ...
        for (i in 0 until indicatorCount) {
            ...
            indicator.setBackgroundResource(R.drawable.indicator_unselected_intro)
        ...
        if (position >= 0 && position <= indicatorCount) {
            ...
            for (index in 0 until indicatorCount) {
                ...
                if (index == selectedPosition) {
                    indicator.setBackgroundResource(R.drawable.indicator_selected_intro)
                } else {
                    indicator.setBackgroundResource(R.drawable.indicator_unselected_intro)
                    indicator.minimumWidth=1
                }
            }
        }
    }
